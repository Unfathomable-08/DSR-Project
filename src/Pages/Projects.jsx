...
const Projects = () => {
            ...
            const fetchData = async () => {
                try {
                    ...
                    for (let project of res.data.data) {
                        const tasksRes = await axios.get(`https://lms-dsr-project.vercel.app/users/task/?project=${project.name}`, {
                            headers: {
                                Authorization: `Bearer ${token}`
                            }
                        });
    ...
    useEffect(() => {
        if(addOrEdit == 'add'){
            if (formData !== "") {
                ...
                const fetchData = async () => {
                    try {
                        const res = await axios.post('https://lms-dsr-project.vercel.app/users/projects/', formData, {
                            headers: {
                                Authorization: `Bearer ${token}`
                            }
                        });
            ...
            if (formData !== "") {
                ...
                const fetchData = async () => {
                    try {
                        const res = await axios.patch('https://lms-dsr-project.vercel.app/users/projects/', formData, {
                            headers: {
                                Authorization: `Bearer ${token}`
                            }
                        });
    ...
    const deleteProject = async (project) => {
        try {
            const token = localStorage.getItem('token');
            const res = await axios.delete('https://lms-dsr-project.vercel.app/users/projects/', {
                headers: {
                    Authorization: `Bearer ${token}`
                },
                data: {
